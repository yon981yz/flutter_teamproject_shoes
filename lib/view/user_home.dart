                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      arguments: [
                                        ...
                                        // snapshot.data!=shoesList
                                      ]
                                      );
                                    },
                                    child: Image.memory(snapshot.data![index].image, width: 130,height: 120,)),
                                  Row(
                                    children: [
                                      Image.memory(snapshot.data![index].logo, width: 40,height: 35,),
                                      Text(snapshot.data![index].name),
                                      Text(snapshot.data![index].salesprice.toString())
                                    ],
                                  ),
                                  DropdownButton<int>(
                                    value: sizeValue,
